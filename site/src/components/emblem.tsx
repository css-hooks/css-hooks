...
function HookPaths({
  ...
  const darkScheme = { color1: V.blue30, color2: V.gray30 };
  const lightScheme = { color1: V.blue40, color2: V.gray50 };
  const { color1, color2 } = theme === "dark" ? darkScheme : lightScheme;
  return (
    <g>
      <path
        style={
  ...
  return (
    <svg viewBox="0 0 600 600" width={size} height={size}>
      <circle
        ...
        cy={300}
        r={300}
        fill={theme === "dark" ? V.gray90 : V.gray10}
      />
      <HookPaths left={133} top={100} theme={theme} />
    </svg>
  );
}
