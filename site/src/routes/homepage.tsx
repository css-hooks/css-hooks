  ...
  return (
    <Html>
      <Head>
        <PageMeta
          pathname={pathname}
          description="Hooks add CSS features to native inline styles, with no build steps and minimal runtime."
        />
      </Head>
      <Body>
        <PageLayout pathname={pathname}>
              ...
              >
                ...
                >
                  <CtaButton
                    ...
                    icon={<Icon.CodeSandbox></Icon.CodeSandbox>}
                  >
                    Demo
                  </CtaButton>
                </div>
          ...
          <Section title="Benefits">
            ...
            >
              ...
              >
                Hooks take the simplest styling approach to the next level,
                removing limitations to make it a viable solution for real-world
                use cases.
              </Feature>
              <Feature
                color="yellow"
              ...
              >
                Effortlessly define styles for states like hover, focus, and
                active. Create engaging UIs without the complexity of external
                CSS.
              </Feature>
              <Feature
                color="teal"
              ...
              >
                Hooks enhance the way you already write inline styles, rather
                than forcing you to learn non-standard utility class syntax.
              </Feature>
              <Feature
                color="green"
              ...
              >
                ...
                reasoning and allowing you to change components quickly and
                easily.
              </Feature>
              <Feature
                color="pink"
            ...
            >
              ...
              >
                ...
                <p style={{ margin: 0 }}>
                  ...
                  {"`style`"}
                  attribute *BUT* with support for a custom set of
                  pseudo-classes, selectors, media/container queries — and
                  nested too!
                </p>
              </Testimonial>
              <Testimonial
              ...
              >
                <p style={{ margin: 0 }}>
                  ...
                  no overhead, and it just makes sense. Best part is that it
                  does this all using native CSS features, nothing fancy - just
              ...
              >
                <p style={{ margin: 0 }}>
                  Looks exactly like what I always wanted the style property to
                  be
                </p>
...
function DesignedFor({
  ...
  return (
    ...
    >
      ...
      <div style={{ order: 99 }}>
        <CtaButton href={`./docs/quickstart/${framework.toLowerCase()}`}>
          Get started
        </CtaButton>
      </div>
      <div
