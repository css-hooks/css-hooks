...
<div align="center" id="badges">
  <a href="https://github.com/css-hooks/css-hooks/tree/v4.0.0-next.41"><img src="https://img.shields.io/badge/tag-v4.0.0--next.41-ffd700" alt="tag v4.0.0-next.41"></a>
  <a href="https://www.npmjs.com/package/@css-hooks/core/v/4.0.0-next.41"><img src="https://img.shields.io/badge/npm-v4.0.0--next.41-ffd700" alt="npm version"></a>
  <a href="https://github.com/css-hooks/css-hooks/blob/v4.0.0-next.41/LICENSE"><img src="https://img.shields.io/badge/license-MIT-ffd700" alt="license"></a>
</div>
...
Flags require custom-property container style queries, available in Chrome and
Edge 111+, Safari 18+, Firefox 151+, Opera 98+, and Samsung Internet 22+.
