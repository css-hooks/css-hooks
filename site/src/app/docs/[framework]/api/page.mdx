...
## <Code className="language-typescript">type HookSpec extends string</Code>

A `HookSpec` is a specific type of string that defines how a given hook works,
following one of these formats:
