...
const HookPaths = component$(
  ({
    ...
    const dark = { color1: V.blue30, color2: V.gray30 };
    const light = { color1: V.blue40, color2: V.gray50 };
    const { color1, color2 } = theme === "dark" ? dark : light;
    return (
      <g>
        <path
          style={
...
export const EmblemContained = component$(
  ({
    theme = "auto",
    size = 500,
  }: {
...
export const Emblem = component$(
  ({ theme = "auto" }: { theme?: "dark" | "light" | "auto" }) => {
    return (
      <svg
        viewBox="0 0 334 400"
        style={{
